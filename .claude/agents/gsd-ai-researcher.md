...
<required_reading>
Read `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
