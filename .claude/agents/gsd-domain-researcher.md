...
<required_reading>
Read `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
