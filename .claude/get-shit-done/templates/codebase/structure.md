...
- Usage: Reference from command with `@/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/wiko/Projects/active/mtg-bulk-sale-page/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/wiko/Projects/active/mtg-bulk-sale-page/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
