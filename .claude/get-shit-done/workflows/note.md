...
- **Global scope**: `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/notes/`)
...
2. Glob `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/notes/` — works in any directory
