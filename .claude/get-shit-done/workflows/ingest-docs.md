...
```bash
INIT=$(node "/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
