...
```
Agent(
  prompt="Read /home/wiko/Projects/active/mtg-bulk-sale-page/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/templates/VALIDATION.md`
