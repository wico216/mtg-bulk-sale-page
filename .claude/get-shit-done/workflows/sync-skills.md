...
INSTALL_JS_GLOBAL="/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
