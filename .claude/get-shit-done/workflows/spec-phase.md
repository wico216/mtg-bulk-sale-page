...
```bash
INIT=$(node "/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/templates/spec.md.
