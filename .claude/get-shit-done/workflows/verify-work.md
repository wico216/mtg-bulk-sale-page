...
<template>
@/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/home/wiko/Projects/active/mtg-bulk-sale-page/.claude/get-shit-done/workflows/diagnose-issues.md
