...
interface WBinderShareInterestState {
  /** Aggregated private W-card ID to interested quantity mapping. */
  ...
  clearInterestList: () => void;
  totalItems: () => number;
}

export const useWBinderShareInterestStore = create<WBinderShareInterestState>()(
  persist(
    (set, get) => ({
      ...
      clearInterestList: () => set({ items: new Map<string, number>() }),
    ...
    {
      name: "wikos-spellbook-w-binder-share-interest-list",
